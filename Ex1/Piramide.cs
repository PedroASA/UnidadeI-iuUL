...
public class Piramide
{
	...
	public Piramide(int n)
	{
        if (n < 1)
        {
            throw new NonPositiveNumberException(String.Format("Valor de N deve ser maior que zero.\nErro:\n\t{0} < 1", n));
        }
	...
	public void Desenha()
	{
        ...
        int total_num = NumOfCharsToN();
        // Número de espaços antes da primeira linha
        int num_space = total_num;
    ...
    [Serializable]
	private class NonPositiveNumberException : Exception
    {
